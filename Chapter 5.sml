...
fun inserta _ _ [] = [] |
    inserta v1 v2 (h::t) = if h=v2
    	       	  	   then (h::v1::t)
			   else inserta v1 v2 t;

(* 10c *)

fun insertaall _ _ [] = [] |
    insertaall v1 v2 (h::t) = if h=v2
    	       	     	      then h::v1::(insertaall v1 v2 t)
			      else h::(insertaall v1 v2 t);
...
fun iinserta _ _ [] = [] |
    iinserta v1 i (h::t) = if i=1
    	     	  	   then h::v1::t
			   else h::(iinserta v1 (i-1) t);
